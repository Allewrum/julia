...
# Модуль Random используется для генерации случайного массива
using Random
...
#= Топ сортировок 
bubble_sort(A): 9.751607 seconds (21.70 k allocations: 1.927 MiB, 0.14% compilation time)
insert_sort(A): 1.252866 seconds (7.11 k allocations: 1.119 MiB, 0.82% gc time, 1.25% compilation time)
comb_sort(A): 0.026981 seconds (20.77 k allocations: 1.875 MiB, 68.58% compilation time)
shell_sort(A): 0.109306 seconds (124.69 k allocations: 7.244 MiB, 43.83% compilation time)
merge_sort(A): 0.267841 seconds (831.54 k allocations: 38.854 MiB, 97.17% compilation time)
quick_sort(A): 0.081678 seconds (375.24 k allocations: 18.645 MiB, 14.96% gc time, 89.38% compilation time)
=#
